...
export declare class TelegramClient {
     ...
     * Send invoices
     */
    sendInvoice(params: SendInvoiceParams): Promise<SendInvoiceResponse>;
    /**
     * Create invoice link
     */
